import { CalendarDays, Salad, Star, UtensilsCrossed } from "lucide-react";
...
const LandingPage = () => {
  ...
  if (isAuthenticated) {
    return (
      <Navigate
        to={role === "CUSTOMER" ? "/customer/dashboard" : "/vendor/dashboard"}
        replace
      />
    );
  }
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-5 mt-10">
            ...
            <div className="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition">
              <CalendarDays className="text-orange-500 mb-2" size={30} />
            ...
            <div className="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition">
              <UtensilsCrossed className="text-red-500 mb-2" size={30} />
            ...
            <div className="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition">
              <Star className="text-yellow-500 mb-2" size={30} />
          ...
          <button
            ...
            className="mt-10 bg-orange-500 hover:bg-orange-600 text-white px-10 py-4 rounded-xl text-lg font-semibold shadow-lg transition duration-300"
          >
            Login
          </button>
        </div>
